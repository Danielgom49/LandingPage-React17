        ...
        return (
            <Background className="grid grid-rows-2 grid-cols-2 pl-44">
                <div className="text-white flex flex-col justify-center items-center text-center w-4/6">
                    <img src="https://res.cloudinary.com/dvcxyjkko/image/upload/v1645539011/proyecto-sprint3-reto1/icon-access-anywhere_amlmgj.svg" alt="img1" width="120" className='py-2 images' />
                ...
                <div className="text-white flex flex-col justify-center items-center text-center w-4/6">
                    <img src="https://res.cloudinary.com/dvcxyjkko/image/upload/v1645539016/proyecto-sprint3-reto1/icon-security_qfkd3f.svg" alt="img2" width="120" className='py-2 images' />
                ...
                <div className="text-white flex flex-col justify-center items-center text-center w-4/6">
                    <img src="https://res.cloudinary.com/dvcxyjkko/image/upload/v1645539023/proyecto-sprint3-reto1/icon-collaboration_n0t4sd.svg" alt="img3" width="120" className='py-2 images' />
                ...
                <div className="text-white flex flex-col justify-center items-center text-center w-4/6">
                    <img src="https://res.cloudinary.com/dvcxyjkko/image/upload/v1645539032/proyecto-sprint3-reto1/icon-any-file_gqviql.svg" alt="img4" width="120" className='py-2 images' />
