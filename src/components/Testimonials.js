...
export default class Testimonials extends Component {
    render() {
        return (
            <Background className="py-5 pb-44 pt-0">
                <div className=" comillas flex items-start content-start ml-24">
                ...
                <Background className="flex flex-col justify-start items-center " >
                    <div className="flex flex-row items-center justify-evenly w-10/12 testimonial">
                        <Card className="mx-3 py-5 flex flex-col justify-center text-white mb-32">
                            ...
                            <div className="flex flex-row my-2 mx-10 items-center user">
